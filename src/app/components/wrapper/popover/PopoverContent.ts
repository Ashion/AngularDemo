import { Component, Input, AfterViewInit, ElementRef, ChangeDetectorRef, OnDestroy, ViewChild, EventEmitter, Renderer, Output } from "@angular/core";
...
export class PopoverContent implements AfterViewInit, OnDestroy {
    ...
    show(): void {
        ...
        this.onShown.emit(this.popover);
    }
    ...
    hide(): void {
        ...
        this.onHidden.emit(this.popover);
    }
